...
extension WidgetExtensions on Widget {
  ...
  Widget get square => AspectRatio(aspectRatio: 1, child: this);

  Widget get positionedZero =>
      Positioned(left: 0, right: 0, top: 0, bottom: 0, child: this);
  ...
  Widget scroll({ScrollController? controller, EdgeInsets? padding}) =>
